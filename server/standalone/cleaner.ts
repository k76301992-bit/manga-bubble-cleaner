...
const configuredExternalBaseUrl = process.env.EXTERNAL_QWEN_BASE_URL || process.env.EXTERNAL_OPENAI_BASE_URL || "https://ggg-production-739f.up.railway.app/v1";
const EXTERNAL_QWEN_BASE_URL = configuredExternalBaseUrl.replace(/\/$/, "").endsWith("/v1") ? configuredExternalBaseUrl.replace(/\/$/, "") : `${configuredExternalBaseUrl.replace(/\/$/, "")}/v1`;
